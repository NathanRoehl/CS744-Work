 ...
 * Returns a StandardAnalyzer for Lucene.
 * Can also be searched using hash set.
 * 
 * @author Nathan Roehl and Nisreen Abdel Karim Ahmad Al Khun
 */
public class StopWordList {

	private static String[] stopWords = {"a","able", "about", "above", "abroad", "according", "accordingly", "across", "actually",
			...
			"yours", "yourself", "yourselves", "you've", "z", "zero","reduce","control","treatment","treat","help","ability",
			"lost","frequent","prevent","decrease"};
